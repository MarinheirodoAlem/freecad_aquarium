...
def create_weir(doc):
    ...
    geo0 = main_face_profile.addGeometry(Part.LineSegment(Vector (800.0, 0.0, 0.0), Vector (0.0, 0.0, 0.0)))
    main_face_profile.toggleConstruction(geo0)
    geo1 = main_face_profile.addGeometry(Part.LineSegment(Vector (0.0, 0.0, 0.0), Vector (0.0, 450.0, 0.0)))
    main_face_profile.toggleConstruction(geo1)
    geo2 = main_face_profile.addGeometry(Part.LineSegment(Vector (800.0, 450.0, 0.0), Vector (0.0, 450.0, 0.0)))
    main_face_profile.toggleConstruction(geo2)
    geo3 = main_face_profile.addGeometry(Part.LineSegment(Vector (800.0, 450.0, 0.0), Vector (800.0, 0.0, 0.0)))
    main_face_profile.toggleConstruction(geo3)
    geo4 = main_face_profile.addGeometry(Part.LineSegment(Vector (8.0, 0.0, 0.0), Vector (792.0, 0.0, 0.0)))
    geo5 = main_face_profile.addGeometry(Part.LineSegment(Vector (792.0, 0.0, 0.0), Vector (792.0, 450.0, 0.0)))
    geo6 = main_face_profile.addGeometry(Part.LineSegment(Vector (792.0, 450.0, 0.0), Vector (8.0, 450.0, 0.0)))
    geo7 = main_face_profile.addGeometry(Part.LineSegment(Vector (8.0, 450.0, 0.0), Vector (8.0, 0.0, 0.0)))
    main_face_profile.addConstraint(Sketcher.Constraint('Coincident', geo3, 2, geo0, 1))
    main_face_profile.addConstraint(Sketcher.Constraint('Horizontal', geo0))
    main_face_profile.addConstraint(Sketcher.Constraint('Horizontal', geo2))
    main_face_profile.addConstraint(Sketcher.Constraint('Vertical', geo1))
    main_face_profile.addConstraint(Sketcher.Constraint('Vertical', geo3))
    main_face_profile.addConstraint(Sketcher.Constraint('DistanceY', geo3, 2, geo3, 1, 450.00))
    main_face_profile.addConstraint(Sketcher.Constraint('DistanceX', geo2, 2, geo2, 1, 800.00))
    main_face_profile.addConstraint(Sketcher.Constraint('Coincident', geo2, 1, geo3, 1))
    main_face_profile.addConstraint(Sketcher.Constraint('Coincident', geo2, 2, geo1, 2))
    main_face_profile.addConstraint(Sketcher.Constraint('Coincident', geo4, 2, geo5, 1))
    main_face_profile.addConstraint(Sketcher.Constraint('Coincident', geo5, 2, geo6, 1))
    main_face_profile.addConstraint(Sketcher.Constraint('Coincident', geo6, 2, geo7, 1))
    main_face_profile.addConstraint(Sketcher.Constraint('Coincident', geo7, 2, geo4, 1))
    main_face_profile.addConstraint(Sketcher.Constraint('Horizontal', geo4))
    main_face_profile.addConstraint(Sketcher.Constraint('Horizontal', geo6))
    main_face_profile.addConstraint(Sketcher.Constraint('Vertical', geo5))
    main_face_profile.addConstraint(Sketcher.Constraint('Vertical', geo7))
    main_face_profile.addConstraint(Sketcher.Constraint('PointOnObject', geo5, 2, geo2))
    main_face_profile.addConstraint(Sketcher.Constraint('Distance', geo2, 1, geo5, 2, 8.00))
    main_face_profile.addConstraint(Sketcher.Constraint('Coincident', -1, 1, geo0, 2))
    main_face_profile.addConstraint(Sketcher.Constraint('Coincident', geo1, 1, geo0, 2))
    main_face_profile.addConstraint(Sketcher.Constraint('DistanceX', geo0, 2, geo4, 1, 8.00))
    main_face_profile.addConstraint(Sketcher.Constraint('PointOnObject', geo4, 1, -1))
    main_face_profile.setExpression('Constraints[18]', 'Config.SidesGlassThickness+Config.BraceWidth')
    main_face_profile.setExpression('Constraints[21]', 'Config.SidesGlassThickness+Config.BraceWidth')
    main_face_profile.setExpression('Constraints[5]', 'Computed.RealGlassHeight')
    main_face_profile.setExpression('Constraints[6]', 'Config.Width')
