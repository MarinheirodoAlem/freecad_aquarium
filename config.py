...
def DefaultsConfig(categories):
    ...
    defcon.addNum('WeirFastenerVerticalCount', 3, 2, 50, 1, 'Number of vertical holes to fasten weir on each line', num, 'weir')
...
def MakeComputed(doc):
    ...
    s.add('WeirHorizontalFastenerSpace', '=WeirHorizontalFastenerHidth/Config.WeirFastenerHorizontalCount')
