...
def MakeComputed(doc):
    ...
    s.add('BeamsSumpSizeWidth', '=(Computed.Width-(2+Config.ColumnsStandWidthCount)*Config.MetalProfileWidth)/(Config.ColumnsStandWidthCount+1)', 'Length of beams in the width size')
